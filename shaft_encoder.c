/* shaft_encoder.c - using TIM3 Measuring Frequency and RPM
...
int main(void) {
    ...
    while (1) {
        ...
        last = current;
				...
				char lineOne[20];
				sprintf(lineOne, "RPM:  %.2f/",frequency*60);
				char lineTwo[20];
				sprintf(lineTwo, "Freq: %.2f/",frequency);	
					
				LCD_displayOut(lineOne, lineTwo);
